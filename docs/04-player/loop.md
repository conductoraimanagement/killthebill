...
- **You're in the severance period.** Months 1–2, hope decay is paused. Rent still comes due on the 1st of each month (HUD modal, [PAY] / [SKIP]), but the psychological weight hasn't found you yet. 60 game days to orient.
